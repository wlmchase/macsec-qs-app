                ...
                while '\n' in self.buffer:
                    ...
                    try:
                        ...
                        match msg_type:
                            ...
                            case _: # Default case (system), just print contents
                                print(f"\n{msg_data['content']}")
...
class CryptoManager:
    ...
    def handle_public_keys(self, data):
        ...
        self.partner_username = data['username'] # set chat partner's username
    ...
    def handle_key_share(self, data):
        ...
        self.shared_secret = self.kem.decap_secret(ciphertext)  # set shared key
